...
public class BaseClass extends MecanumDrive {
   ...
   // double intakerotpose=0,gearboxpose=0;
    ...
    public void hang() {
        ...
        pidfsetting(1600); // Hit arm with low rung //1500
...
//           pidfsetting(rotate_spec_in - 200,pidf_intake_spec);
       ...
       {
           pidfsetting(rotate_spec_in+140);
           flag[spec] = false;
           return true;
       }
...
//            Intake_handle.setPosition(handle_specimen_outtake - 0.04);
            pidfsetting(rotate_spec_out + 600 ); //650
            delay(300); //200
//            Intake.setPower(-0.9);
            stop_drive();
            delay(200); //150
