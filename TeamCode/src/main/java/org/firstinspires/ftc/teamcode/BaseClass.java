...
public class BaseClass extends MecanumDrive {
   ...
   // int armslideOutSpec = 858 /*1800*/;
    ...
    int field = 0; // 0 is left field, 1 is right field
...
//        pidfsetting(rotate_idle, pidf_intake_idle);
...

    {
       if(tstep==0) { //for both
           ...
           pidftable[pidf_outtake_up2][pp]=0.00055;  pidftable[pidf_outtake_up2][ii]=0.0;  pidftable[pidf_outtake_up2][dd]=0.0001;//0.00075 // i = 0.00012
...
//        if (power < -1.0) power = -0.98;
    ...
    public boolean lift() {
        ...
        if(-(Arm_right.getCurrentPosition())>2000){
            ...
            linearslide(slide_outtake,slidev0);
            flag[lift]=false;
            return true;
        }
