...
//            Intake_rot.setPosition(handlerot_intake);
...

    {
       if(tstep==0) { //for both
           ...
           afmoveconfig[3] [xdis]=-13;
           afmoveconfig[3] [ydis]=41;
